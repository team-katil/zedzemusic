...
import config
from ZedzeX import Carbon, YouTube, app
from ZedzeX.core.call import Zedze
from ZedzeX.misc import db
from ZedzeX.utils.database import (add_active_chat,
                                       add_active_video_chat,
                                       is_active_chat,
                                       is_video_allowed, music_on)
from ZedzeX.utils.exceptions import AssistantErr
from ZedzeX.utils.inline.play import (stream_markup, queue_markup,
                                          telegram_markup)
from ZedzeX.utils.inline.playlist import close_markup
from ZedzeX.utils.pastebin import Zedzebin
from ZedzeX.utils.stream.queue import put_queue, put_queue_index
from ZedzeX.utils.thumbnails import gen_thumb, gen_qthumb
...
async def stream(
    ...
    if forceplay:
        await Zedze.force_stop_stream(chat_id)
