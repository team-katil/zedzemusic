...
async def gen_thumb(videoid, user_id):
    ...
    try:
        ...
        image2 = Image.open(f"ZedzeX/assets/{images}.png")
        ...
        font = ImageFont.truetype("ZedzeX/assets/font.otf", 32)
        ...
        draw.text((190, 650), f"Powered By: Katil (@katil_your_dad)", (255, 255, 255), font=font)
        try:
            os.remove(f"cache/thumb{videoid}.png")
